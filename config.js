/**
 * @file Centralized environment-based configuration
 * @description Loads all configuration from environment variables
 * Supports Discord, Pterodactyl, Falix, and OpenAI settings
 * No secrets are hard-coded or exposed
 */
...
module.exports = {
	...
	pterodactyl: {
		...
		WINGS_API_TIMEOUT: numberEnv(
			"WINGS_API_TIMEOUT",
			2500
		),
	},

	// Falix Configuration (optional)
	falix: {
		apiKey: process.env.FALIX_API_KEY || "",
		serverId: process.env.FALIX_SERVER_ID || "",
	},
